...
sh "curl -o app/_data/${n}.json 'https://eu.api.battle.net/wow/character/Elune/${n}?fields=professions,items,statistics,progression,talents&locale=fr_FR&apikey=${env.APIKEY}'"
sleep 1
}
}
stage ('build') {
