...
// count for ilevel
    ...
    private function displayStuff($character) {
        ...
        $tmp .= '<div class="col-xs-1 mw">&nbsp;</div><div class="col-xs-1 mw">&nbsp;</div><div class="col-xs-4 mw"><a href="' . Utils::getPersoHash($character) . '" class="btn btn-info" role="button">Détails</a></div>';
        return $tmp;
    }
